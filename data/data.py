cpu = {  # cpu[manufacturer][gen][model]: cores, threads, clock, cache, tdp, released(month.year), price
    'intel': {
        'i3': {
            '10gen': {
                '10100f': {
...
motherboard = {  # motherboard[cpu][socket][chipset]: gen, ram_type, manufacturer: form_factor: ram_count, m2, price
    'intel': {
        'lga1200': {
            'h470': {
                'gen': ['10gen', '11gen'],
...
gpu = {
    # gpu[orig][gen][model]: memory, memory_type, tdp, computer_bus, released(month.year), manufacturer: name: price
    'nvidia': {
        '10s': {
            '1030': {
                'memory': 2048,
...
ram = {  # ram[type][size][clock][manufacturer]: price
    'ddr4': {
        8: {
            2666: {
                'kingston': 2250
...
ssd = {  # ssd[type][size][manufacturer][model]: price, read, write
    'm2': {
        256: {
            'kingston': {
                'nv1': {
...
hdd = {  # ssd[size][manufacturer]: price, speed
    1: {
        'seagate': {
            'price': 6199,
            'speed': 7200
...
psu = {  # psu[power][manufacturer][model]: certificate, modular, price
    500: {
        'bequiet': {
            '9': {
                'certificate': 'bronze',
...
readable_format = {
    ...
    "1060x3": "NVidia GeForce GTX 1060x3",
    "1060x6": "NVidia GeForce GTX 1060x6",
    ...
    "2060x6": "NVidia GeForce RTX 2060x6",
    ...
    "3050x4": "NVidia GeForce RTX 3050x4",
    "3050x8": "NVidia GeForce RTX 3050x8",
    "3060x8": "NVidia GeForce RTX 3060x8",
